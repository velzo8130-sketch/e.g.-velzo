...
const PRODUCTS = [
  {id:"aura-earbuds",name:"Aura Wireless Earbuds",cat:"Tech",icon:"earbuds",price:39.99,old:59.99,tag:"Bestseller",
  ...
  {id:"pulse-watch",name:"Pulse Smart Watch",cat:"Tech",icon:"watch",price:59.99,old:89.99,tag:"Trending",
  ...
  {id:"novaglow-lamp",name:"NovaGlow LED Desk Lamp",cat:"Home",icon:"lamp",price:24.99,old:34.99,tag:"New",
  ...
  {id:"flexmount-stand",name:"FlexMount Phone Stand",cat:"Lifestyle",icon:"stand",price:14.99,old:null,tag:"Value pick",
  ...
  {id:"trekpack-backpack",name:"TrekPack Foldable Backpack",cat:"Lifestyle",icon:"backpack",price:34.99,old:44.99,tag:"Trending",
  ...
  {id:"coreflask-bottle",name:"CoreFlask Insulated Bottle",cat:"Lifestyle",icon:"bottle",price:19.99,old:null,tag:null,
  ...
  {id:"airclip-charger",name:"AirClip Wireless Charger",cat:"Tech",icon:"charger",price:22.99,old:29.99,tag:null,
  ...
  {id:"snaplight-projector",name:"SnapLight Mini Projector",cat:"Home",icon:"projector",price:79.99,old:109.99,tag:"New",
  ...
  {id:"zenband-tracker",name:"ZenBand Fitness Tracker",cat:"Tech",icon:"tracker",price:27.99,old:null,tag:"Bestseller",
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  if(orderForm){
    ...
    orderForm.addEventListener("submit", (e)=>{
      ...
      document.getElementById("summary-total").textContent = "$"+total+" (due on delivery)";
